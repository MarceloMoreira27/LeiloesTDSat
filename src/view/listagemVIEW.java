...
public class ListagemVIEW extends javax.swing.JFrame {
    ...
    public boolean verificarCampoID(String id){
        ...
        if(!id.matches("\\d+")){
           JOptionPane.showMessageDialog(null, "ID deve conter apenas números!.");
            return false;
       }
    ...
    private void initComponents() {
        ...
        txt_id_produto_venda = new javax.swing.JTextPane();
        ...
        jScrollPane2.setViewportView(txt_id_produto_venda);
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        String idString = txt_id_produto_venda.getText();
        
        
        if(verificarCampoID(idString)){
            ...
            try {
                ...
                String status = produtosDao.buscarStatus(id);
        
                if (status == null) {
                    JOptionPane.showMessageDialog(null, "ID não encontrado no sistema.");
            
                } else if (status.equalsIgnoreCase("Vendido")) {
        ...
        txt_id_produto_venda.setText(null);
    ...
    private javax.swing.JTextPane txt_id_produto_venda;
